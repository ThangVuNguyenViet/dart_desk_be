...
--
-- Class CmsApiToken as table cms_api_tokens
--
...
--
-- Class CmsDeployment as table cms_deployments
--
...
--
-- Foreign relations for "cms_api_tokens" table
--
...
--
-- Foreign relations for "cms_deployments" table
--
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('dart_desk_be', '20260321131809739', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260321131809739', "timestamp" = now();
