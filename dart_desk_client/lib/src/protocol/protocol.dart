...
import 'crdt_operation_type.dart' as _i6;
import 'deployment.dart' as _i7;
import 'deployment_status.dart' as _i8;
import 'document.dart' as _i9;
import 'document_crdt_operation.dart' as _i10;
import 'document_crdt_snapshot.dart' as _i11;
import 'document_data.dart' as _i12;
...
import 'package:dart_desk_client/src/protocol/api_token.dart' as _i26;
import 'package:dart_desk_client/src/protocol/deployment.dart' as _i27;
import 'package:dart_desk_client/src/protocol/document_crdt_operation.dart'
    as _i28;
import 'package:dart_desk_client/src/protocol/media_asset.dart' as _i29;
import 'package:dart_desk_client/src/protocol/migration_history.dart' as _i30;
import 'package:dart_desk_client/src/protocol/public_document.dart' as _i31;
...
class Protocol extends _i1.SerializationManager {
  ...
  T deserialize<T>(
    ...
    if (t == _i6.CrdtOperationType) {
      return _i6.CrdtOperationType.fromJson(data) as T;
    }
    if (t == _i7.Deployment) {
      return _i7.Deployment.fromJson(data) as T;
    }
    if (t == _i8.DeploymentStatus) {
      return _i8.DeploymentStatus.fromJson(data) as T;
    }
    if (t == _i9.Document) {
    ...
    if (t == _i12.DocumentData) {
      return _i12.DocumentData.fromJson(data) as T;
    }
    ...
    if (t == _i1.getType<_i6.CrdtOperationType?>()) {
      return (data != null ? _i6.CrdtOperationType.fromJson(data) : null) as T;
    }
    if (t == _i1.getType<_i7.Deployment?>()) {
      return (data != null ? _i7.Deployment.fromJson(data) : null) as T;
    }
    if (t == _i1.getType<_i8.DeploymentStatus?>()) {
      return (data != null ? _i8.DeploymentStatus.fromJson(data) : null) as T;
    }
    ...
    if (t == _i1.getType<_i12.DocumentData?>()) {
      return (data != null ? _i12.DocumentData.fromJson(data) : null) as T;
    }
    ...
    if (t == List<_i9.Document>) {
      return (data as List).map((e) => deserialize<_i9.Document>(e)).toList()
          as T;
    }
    ...
    if (t == List<_i30.MigrationHistory>) {
      return (data as List)
              .map((e) => deserialize<_i30.MigrationHistory>(e))
              .toList()
          as T;
    }
  ...
  static String? getClassNameForType(Type type) {
    return switch (type) {
      ...
      _i6.CrdtOperationType => 'CrdtOperationType',
      _i7.Deployment => 'Deployment',
      _i8.DeploymentStatus => 'DeploymentStatus',
      _i9.Document => 'Document',
      _i10.DocumentCrdtOperation => 'DocumentCrdtOperation',
      _i11.DocumentCrdtSnapshot => 'DocumentCrdtSnapshot',
      _i12.DocumentData => 'DocumentData',
  ...
  String? getClassNameForObject(Object? data) {
    ...
    switch (data) {
      ...
      case _i5.CmsClient():
        return 'CmsClient';
      case _i6.CrdtOperationType():
        return 'CrdtOperationType';
      case _i7.Deployment():
        return 'Deployment';
      case _i8.DeploymentStatus():
  ...
  dynamic deserializeByClassName(Map<String, dynamic> data) {
    ...
    if (dataClassName == 'CrdtOperationType') {
      return deserialize<_i6.CrdtOperationType>(data['data']);
    }
    if (dataClassName == 'Deployment') {
      return deserialize<_i7.Deployment>(data['data']);
    }
    if (dataClassName == 'DeploymentStatus') {
      return deserialize<_i8.DeploymentStatus>(data['data']);
    }
    ...
    if (dataClassName == 'DocumentData') {
      return deserialize<_i12.DocumentData>(data['data']);
    }
