...
import 'document_list_response.dart' as _i9;
import 'document_version.dart' as _i10;
import 'document_version_list_response.dart' as _i11;
...
class Protocol extends _i1.SerializationManagerServer {
  ...
  static final List<_i2.TableDefinition> targetTableDefinitions = [
    ...
    _i2.TableDefinition(
      ...
      indexes: [
        ...
        _i2.IndexDefinition(
          indexName: 'documents_client_id_idx',
          tableSpace: null,
          elements: [
            _i2.IndexElementDefinition(
              type: _i2.IndexElementDefinitionType.column,
        ...
        _i2.IndexDefinition(
          indexName: 'documents_document_type_idx',
          tableSpace: null,
          elements: [
            _i2.IndexElementDefinition(
              type: _i2.IndexElementDefinitionType.column,
        ...
        _i2.IndexDefinition(
          indexName: 'documents_current_version_idx',
          tableSpace: null,
          elements: [
            _i2.IndexElementDefinition(
              type: _i2.IndexElementDefinitionType.column,
  ...
  T deserialize<T>(
    ...
    if (t == _i9.DocumentListResponse) {
      return _i9.DocumentListResponse.fromJson(data) as T;
    }
    if (t == _i10.DocumentVersion) {
      return _i10.DocumentVersion.fromJson(data) as T;
    }
    if (t == _i11.DocumentVersionListResponse) {
      return _i11.DocumentVersionListResponse.fromJson(data) as T;
    }
    if (t == _i12.MediaFile) {
    ...
    if (t == _i1.getType<_i9.DocumentListResponse?>()) {
      return (data != null ? _i9.DocumentListResponse.fromJson(data) : null)
          as T;
    }
    if (t == _i1.getType<_i10.DocumentVersion?>()) {
      return (data != null ? _i10.DocumentVersion.fromJson(data) : null) as T;
    }
    if (t == _i1.getType<_i11.DocumentVersionListResponse?>()) {
      return (data != null
          ? _i11.DocumentVersionListResponse.fromJson(data)
          : null) as T;
    }
  ...
  String? getClassNameForObject(Object? data) {
    ...
    if (data is _i7.CmsUser) {
      return 'CmsUser';
    }
    if (data is _i8.Document) {
      return 'Document';
    }
    if (data is _i9.DocumentListResponse) {
      return 'DocumentListResponse';
    }
    if (data is _i10.DocumentVersion) {
      return 'DocumentVersion';
    }
    if (data is _i11.DocumentVersionListResponse) {
  ...
  dynamic deserializeByClassName(Map<String, dynamic> data) {
    ...
    if (dataClassName == 'DocumentListResponse') {
      return deserialize<_i9.DocumentListResponse>(data['data']);
    }
    ...
    if (dataClassName == 'DocumentVersionListResponse') {
      return deserialize<_i11.DocumentVersionListResponse>(data['data']);
    }
