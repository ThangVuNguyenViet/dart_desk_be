    ...
    (sessionBuilder, endpoints) {
      ...
      group('getMedia', () {
        test('returns media metadata by assetId', () async {
          ...
          final media =
              await endpoints.media.getMedia(authed, uploaded.assetId);
      ...
      group('deleteMedia', () {
        test('deletes media file', () async {
          ...
          final deleted =
              await endpoints.media.deleteMedia(authed, uploaded.assetId);
      ...
      group('getMediaUsageCount', () {
        test('returns zero for unused asset', () async {
          final uploaded =
              await factory.uploadTestImage(fileName: 'unused.png');
          final authed = factory.authenticatedSession();
      ...
      group('updateMediaAsset', () {
        test('renames media file', () async {
          final uploaded =
              await factory.uploadTestImage(fileName: 'original.png');
          final authed = factory.authenticatedSession();
