...
-- Indexes
CREATE INDEX "api_key_project_idx" ON "api_keys" USING btree ("projectId");
CREATE UNIQUE INDEX "api_key_lookup_idx" ON "api_keys" USING btree ("projectId", "tokenPrefix", "tokenSuffix");
CREATE INDEX "api_key_prefix_suffix_idx" ON "api_keys" USING btree ("tokenPrefix", "tokenSuffix");

--
-- Class CmsClient as table clients
--
...
--
-- Class Deployment as table deployments
--
...
-- Partial unique index: allows slug reuse after soft-delete within a project+type.
CREATE UNIQUE INDEX "documents_project_type_slug_active_idx"
  ON "documents" ("projectId", "documentType", "slug")
  WHERE "deletedAt" IS NULL;
...
--
-- Class MediaAsset as table media_assets
--
...
--
-- Class MigrationHistory as table migration_history
--
...
--
-- Class ProjectMember as table project_members
--
...
--
-- Class Project as table projects
--
...
--
-- Class PublishedDocument as table published_documents
--
...
-- Partial unique index: allows email reuse after soft-delete within a client.
CREATE UNIQUE INDEX "users_client_email_active_idx"
  ON "users" ("clientId", "email")
  WHERE "deletedAt" IS NULL;
...
--
-- Foreign relations for "api_keys" table
--
...
--
-- Foreign relations for "deployments" table
--
...
--
-- Foreign relations for "media_assets" table
--
...
--
-- Foreign relations for "migration_history" table
--
...
--
-- Foreign relations for "project_members" table
--
...
--
-- Foreign relations for "projects" table
--
...
--
-- Foreign relations for "published_documents" table
--
