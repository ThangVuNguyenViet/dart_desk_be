...
--
-- Class ApiToken as table api_tokens
--
...
-- Schema drift: generated column + GIN index for jsonb containment lookups.
-- See dart_desk_be/CLAUDE.md for full rationale.
ALTER TABLE "documents"
  ADD COLUMN "data_jsonb" jsonb
  GENERATED ALWAYS AS ((data)::jsonb) STORED;
CREATE INDEX "documents_data_gin"
  ON "documents" USING GIN ("data_jsonb");
...
--
-- Foreign relations for "api_tokens" table
--
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('dart_desk', '20260502061331738', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260502061331738', "timestamp" = now();
